...
schema_view = get_schema_view(
        openapi.Info(
            ...
            description = '''This API provides the necessary backend resources for the functioning of Virtual Contest Maker''', 
...
urlpatterns = [
    ...
    path('api/docs/swagger', schema_view.with_ui('swagger', cache_timeout=0), name='swagger-api-docs'),
